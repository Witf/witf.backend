...
class RecipeSearchBoxClass extends React.Component {
    constructor() {
        super();
        this.state = {
            value: '',
...
const provider = provide((state) => state.recipeSearchsState, recipeSearchActions).withExternalProps();
export const RecipeSearchBox = provider.connect(RecipeSearchBoxClass);
//# sourceMappingURL=recipeSearchBox.jsx.map